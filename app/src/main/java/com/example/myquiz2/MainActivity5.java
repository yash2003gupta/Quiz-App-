...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent iNext;
        iNext = new Intent(MainActivity5.this, MainActivity6.class);


        iNext.putExtra("Answer", "Paris");
        ...
        Intent iNextB;
        iNextB = new Intent(MainActivity5.this, MainActivity9.class);
        ...
        Intent iNextp;
        iNextp = new Intent(MainActivity5.this, MainActivity2.class);
        ...
        submitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Paris"; // Replace this with the actual correct answer string
                if (userAnswer.equals(correctAnswer)) {
                    ...
                    Toast.makeText(MainActivity5.this,"choose one" , Toast.LENGTH_SHORT).show();
                }

                else {
                    Toast.makeText(MainActivity5.this, "Wrong!show the Answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
